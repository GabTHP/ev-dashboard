...
import { TableExportPdfTransactionsAction, TableExportPdfTransactionsActionDef } from '../../../shared/table/actions/transactions/table-export-pdf-transactions-action';
...
export class TransactionsRefundTableDataSource extends TableDataSource<Transaction> {
  ...
  private exportPdfTransactionsAction = new TableExportPdfTransactionsAction().getActionDef();
        ...
        .subscribe({
          next: (transactions) => {
            ...
            this.transactionsAuthorizations = {
              ...
              canExportPdf: Utils.convertToBoolean(transactions.canExportPdf),
            ...
            this.exportPdfTransactionsAction.visible = this.transactionsAuthorizations.canExportPdf;
  ...
  public buildTableActionsDef(): TableActionDef[] {
    ...
    return [
      ...
      this.exportPdfTransactionsAction,
      ...tableActionsDef,
    ];
  }
