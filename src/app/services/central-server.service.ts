...
export class CentralServerService {
  ...
  public exportTransactionsPdf(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient.get(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_EXPORT_PDF),
      {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
