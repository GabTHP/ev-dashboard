...
export interface TableExportPdfTagsActionDef extends TableActionDef {
...
export class TableExportPdfTagsAction extends TableDeleteManyAction {
  public getActionDef(): TableExportPdfTagsActionDef {
    return {
      ...super.getActionDef(),
      id: TagButtonAction.EXPORT_PDF_TAGS,
      action: this.exportPdfTags,
      visible: false
    };
  }

  private exportPdfTags(tags: Tag[], dialogService: DialogService, translateService: TranslateService,
    messageService: MessageService, centralServerService: CentralServerService, spinnerService: SpinnerService,
